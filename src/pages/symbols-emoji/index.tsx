...
const pageSize = 8;
const emojiCategoryId = "symbols-emoji";
  ...
  return (
    <div>
      <MetaData
        ...
        description={`Discover a complete list of ${emojiCategoryText}, including currency, zodiac signs, arrows, and more. Find the perfect symbol to express yourself. Browse now!`}
      />
      <EmojisList
