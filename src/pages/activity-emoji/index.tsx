  ...
  return (
    <div>
      <MetaData
        ...
        description={`Looking for a complete list of ${emojiCategoryText}? Discover all the activity-related emojis, including sports, hobbies, and other fun activities. Browse now!`}
      />
      <SectionContainer>
        <EmojisList
